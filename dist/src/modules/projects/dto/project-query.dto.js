...
class ProjectQueryDto extends dto_1.PaginationQueryDto {
    category;
    status;
    featured;
    skill;
...
], ProjectQueryDto.prototype, "featured", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by skill name, e.g. "NestJS"' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ProjectQueryDto.prototype, "skill", void 0);
