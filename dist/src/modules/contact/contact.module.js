...
const prisma_contact_repository_1 = require("./repositories/prisma-contact.repository");
...
exports.ContactModule = ContactModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [contact_service_1.ContactService, contact_repository_interface_1.CONTACT_REPOSITORY],
    })
], ContactModule);
