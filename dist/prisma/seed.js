...
const client_1 = require("../src/database/generated/prisma/client");
const enums_1 = require("../src/database/generated/prisma/enums");
...
async function main() {
    ...
    const owner = await prisma.user.upsert({
        ...
        update: {
            ...
            avatarUrl: 'https://avatars.githubusercontent.com/u/LikeAshraful',
    ...
    const skillsData = [
        {
            name: 'PHP',
            category: enums_1.SkillCategory.LANGUAGES,
            proficiency: 98,
        ...
        {
            name: 'Laravel',
            category: enums_1.SkillCategory.BACKEND_FRAMEWORKS,
            proficiency: 98,
            yearsOfExperience: 7.0,
            isFeatured: true,
            sortOrder: 1,
        ...
        {
            name: 'Vue.js',
            category: enums_1.SkillCategory.FRONTEND_FRAMEWORKS,
            proficiency: 92,
            yearsOfExperience: 5.0,
            isFeatured: true,
            sortOrder: 1,
        ...
        {
            name: 'MySQL',
            category: enums_1.SkillCategory.DATABASES,
            proficiency: 96,
            yearsOfExperience: 7.0,
            isFeatured: true,
            sortOrder: 1,
        ...
        {
            name: 'Docker',
            category: enums_1.SkillCategory.DEVOPS_CLOUD,
            proficiency: 90,
        ...
        },
        {
            ...
            category: enums_1.SkillCategory.TOOLS_ARCHITECTURE,
            proficiency: 96,
            yearsOfExperience: 7.0,
            isFeatured: true,
            sortOrder: 1,
    ...
    const projectsData = [
        {
            ...
            summary: 'Comprehensive enterprise resource planning (ERP) platform featuring multi-branch inventory, point of sale (POS), automated billing, payroll, and real-time financial reporting.',
...
- **Caching & Queues:** Redis caching for product catalog lookups and asynchronous job queues for ledger generation.`,
            ...
            featured: true,
            status: enums_1.ProjectStatus.PUBLISHED,
            category: enums_1.ProjectCategory.FULLSTACK,
            sortOrder: 1,
            viewsCount: 3200,
            likesCount: 185,
            skills: [
        ...
        },
        {
            ...
            summary: 'Scalable online news media publishing portal and headless CMS handling 1M+ monthly pageviews with sub-second response times using multi-tier Redis caching.',
...
- **Real-Time Push Notifications:** Web and mobile push notifications for instant breaking news distribution.`,
            ...
            bannerUrl: 'https://images.unsplash.com/photo-1495020689067-958852a7765e?w=1200&auto=format&fit=crop&q=80',
        ...
        },
        {
            ...
            summary: 'Online Travel Agency (OTA) booking backend integrated with Global Distribution Systems (Amadeus & Sabre GDS) for real-time flight search, seat reservations, and payment processing.',
...
- **Automated Ticket Issuance:** Background job queues handling PNR creation, e-ticket PDF generation, and automated customer email/SMS confirmations.`,
            thumbnailUrl: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=800&auto=format&fit=crop&q=80',
            ...
            featured: true,
            status: enums_1.ProjectStatus.PUBLISHED,
            category: enums_1.ProjectCategory.BACKEND,
            sortOrder: 3,
            viewsCount: 2800,
            likesCount: 160,
            skills: [
        ...
        },
        {
            ...
            summary: 'Robust multi-vendor e-commerce marketplace featuring high-concurrency cart processing, inventory tracking, flash deals, and seamless payment gateways (SSLCommerz, bKash, Nagad, Stripe).',
...
- **Database Query Tuning:** Optimized complex relational queries, composite indexing, and database read-replicas, speeding up product catalog queries by 45%.`,
            thumbnailUrl: 'https://images.unsplash.com/photo-1556742049-0a67e557229b?w=800&auto=format&fit=crop&q=80',
        ...
        },
        {
            ...
            summary: 'High-reliability asynchronous notification microservice handling bulk transactional SMS, email alerts, and webhook triggers with queue retry policies.',
...
- **Audit & Analytics:** Real-time delivery status logging, failure metrics, and client quota management.`,
    ...
    console.log(`✅ Seeded ${projectsData.length} projects with skill associations`);
    const experiencesData = [
        {
            ...
            endDate: null,
            isCurrent: true,
            description: 'Architecting and developing enterprise-scale backend services, microservices, and secure RESTful APIs using PHP (Laravel) and Node.js.',
            highlights: [
        ...
        },
        {
            ...
            isCurrent: false,
            description: 'Led backend engineering and architectural design for flagship products including SellsERP, SaaS platforms, and multi-branch POS applications.',
            highlights: [
        ...
        },
        {
            ...
            isCurrent: false,
            description: 'Collaborated in an international remote agile team developing modular backend services and API integrations.',
            highlights: [
        ...
        },
        {
            ...
            isCurrent: false,
            description: 'Led backend feature development and database performance optimizations for a high-concurrency multi-vendor e-commerce platform.',
            highlights: [
        ...
        },
        {
            ...
            isCurrent: false,
            description: 'Engineered and maintained the core digital news portal and custom CMS powering over 1M+ monthly pageviews.',
            highlights: [
    ...
    const educationData = [
        {
            ...
            description: 'Comprehensive curriculum covering Data Structures, Algorithms, Relational Database Management Systems (RDBMS), Object-Oriented Software Design, Computer Networks, and Web Application Engineering.',
    ...
    const articlesData = [
        {
            ...
            summary: 'A comprehensive guide on building scalable, multi-branch ERP solutions using the Repository pattern, database partitioning, and Redis-driven queue workers.',
...
By combining strict architectural patterns, query optimization, and decoupled background workers, your Laravel backend can effortlessly scale to handle massive transaction volumes.`,
        ...
        },
        {
            ...
            summary: 'Lessons learned scaling high-traffic news platforms like Barta24 to millions of monthly readers using Redis multi-tier caching and SQL index tuning.',
...
Configure Laravel's database connection pool to route write operations to the primary MySQL server and all read queries to read-replicas.`,
            coverImageUrl: 'https://images.unsplash.com/photo-1495020689067-958852a7765e?w=1200&auto=format&fit=crop&q=80',
    ...
    const sampleContact = {
        ...
        message: 'Hello Ashraful, We reviewed your profile and extensive experience with Laravel, high-throughput systems, and ERP solutions. We would love to connect regarding an engineering leadership opportunity.',
    ...
    await prisma.analyticsMetric.createMany({
        data: [
            ...
            {
                type: enums_1.MetricType.RESUME_DOWNLOAD,
